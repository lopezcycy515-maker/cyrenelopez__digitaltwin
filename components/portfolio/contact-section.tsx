  ...
  return (
    <section id="contact" className="border-b border-pink-700/10 bg-pink-700/3">
      <div className="mx-auto max-w-2xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <p className="mb-12 text-gray-600">Have a project in mind? Let&apos;s collaborate!</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-pink-700/20 bg-white px-4 py-3 text-gray-900 placeholder-gray-300 focus:border-pink-700 focus:outline-none"
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="w-full rounded-lg border border-pink-700/20 bg-white px-4 py-3 text-gray-900 placeholder-gray-300 focus:border-pink-700 focus:outline-none resize-none"
