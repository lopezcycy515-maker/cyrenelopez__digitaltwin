...
export function AboutSection() {
  return (
    <section id="about" className="border-b border-pink-700/10 bg-pink-700/3">
        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-pink-700">What I Do</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-pink-700">My Approach</h3>
              <ul className="space-y-3">
                <li className="flex gap-3">
                  <span className="text-pink-700 font-bold">•</span>
